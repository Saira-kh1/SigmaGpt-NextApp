...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Next.js 15 frontend + API routes, MongoDB — built to scale from day one.",
  },
];
    ...
    >
      ...
      <section className="relative z-10 flex flex-col items-center px-6 pb-24 text-center pt-28">
        ...
        <p className="max-w-xl mt-6 text-lg leading-relaxed text-gray-400">
          A full-stack AI chat platform with persistent conversations, guest access, and
          lightning-fast responses — built to production standards.
        </p>
        ...
        <div className="w-full max-w-3xl mx-auto mt-16 overflow-hidden border shadow-2xl rounded-2xl border-white/10 shadow-black/60">
          <div className="flex items-center gap-2 px-4 py-3 bg-gray-900 border-b border-white/5">
            ...
            <span className="ml-3 font-mono text-xs text-gray-500">sigmagpt.app/chat</span>
          </div>
          <div className="p-5 space-y-4 bg-gray-900">
            ...
            <div className="flex gap-2 pt-2">
              ...
              <div className="px-4 py-2.5 bg-green-500 rounded-lg text-sm font-semibold text-black">
                Send
              </div>
            </div>
          </div>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map((f, i) => (
            ...
            >
              ...
              <div
                className="absolute inset-0 transition-opacity opacity-0 pointer-events-none rounded-2xl group-hover:opacity-100"
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-2xl mx-auto text-center">
          <div
            ...
            style={{ background: "linear-gradient(135deg, #16a34a40, #4ade8020, #16a34a40)" }}
          >
            <div className="px-8 bg-gray-950 rounded-2xl py-14">
              <h2 className="mb-4 text-4xl font-black tracking-tight">Ready to build smarter?</h2>
      ...
      <footer className="relative z-10 flex flex-col items-center justify-between gap-4 px-8 py-8 text-sm text-gray-500 border-t border-white/5 sm:flex-row">
        ...
        <span>Built with Next.js · TypeScript · MongoDB · Groq</span>
